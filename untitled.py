...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\cnl\\Desktop\\remy\\dani\\PEAC\\untitled.py',
...
for thisTrial_2 in trials_2:
    ...
    trials.addData('joystick.x_', my_xpositions)
    trials.addData('joystick.y_', my_ypositions)
    trials.addData('joystick.t_', my_times)
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if routineForceEnded:
        routineTimer.reset()
    else:

...
for thisControlTaskOrder in controlTaskOrder:
    ...
    for thisPart1 in part1:
        ...
        for thisTrialsTest1_1 in trialsTest1_1:
            ...
            trialsTest1_1.addData('button_resp.keys',button_resp.keys)
            if button_resp.keys != None:  # we had a response
                trialsTest1_1.addData('button_resp.rt', button_resp.rt)
        ...
        trialsTest1_2 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests2.xlsx', selection='0:20'),
        ...
        trialsTest1_3 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests3.xlsx', selection='0:20'),
        ...
        trialsTest1_4 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests4.xlsx', selection='0:20'),
    ...
    for thisPart2 in part2:
        ...
        trialsTestImages2_1 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests1_Reversed.xlsx', selection='0:20'),
        ...
        trialsTestImages2_2 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests2_Reversed.xlsx', selection='0:20'),
        ...
        trialsTestImages2_3 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests3_Reversed.xlsx', selection='0:20'),
        ...
        trialsTestImages2_4 = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('ImageTests4_Reversed.xlsx', selection='0:20'),
